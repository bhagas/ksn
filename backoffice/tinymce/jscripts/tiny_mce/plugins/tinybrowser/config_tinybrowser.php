...
$_SESSION[$tinybrowser['sessioncheck']] = 'ok';
$mypath=$_SESSION['1mypath'];
...
$tinybrowser['path']['image'] = $mypath."/images/"; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = $mypath."/media/"; // Media files location
$tinybrowser['path']['file']  = $mypath."/files/"; // Other files location
...
$tinybrowser['filetype']['file']  = '*.pdf, *.*'; // Other file types
